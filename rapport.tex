...
Ce n'était pas la chose la plus compliqué à faire, mais il fallait la faire correctement. Dans le fichier "seq/std_seq.hcl" nous avons ajouté l'instructions :
\begin{verbatin}
	int instr_next_ifun = [
		1 : -1;
	];
